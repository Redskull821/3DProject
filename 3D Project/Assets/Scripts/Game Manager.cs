...
public class GameManager : MonoBehaviour
{
    ...
    void EarlyEightBall()
    {
        if (currentPlayer == CurrentPlayer.Player1)
        {
            Lose("Player 1 Hit The 8-Ball In Too Early And Has Lost!");
        }
        else
        {
            Lose("Player 2 Hit The 8-Ball In Too Early And Has Lost!");
        }
    }

    void ScrathOnWinningShot(string player)
    {
